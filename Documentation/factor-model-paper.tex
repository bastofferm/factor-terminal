...
% ---------------------------------------------------------------------
%  Display equations sit in a tinted panel with a navy edge.
%
%  A paper of this kind is read twice: once linearly, and once by someone
%  hunting for the one formula they need. The panel is for the second reader
%  — it makes the equations findable by scanning rather than by reading, and
%  it ties them to the same navy the section headings and the application use.
%  empheq keeps the equation number outside the panel, where a cross-reference
%  expects to find it.
% ---------------------------------------------------------------------
\newtcbox{\eqbox}{
  enhanced, nobeforeafter, tcbox raise base,
  boxrule=0pt, sharp corners=all,
  top=7pt, bottom=7pt, left=13pt, right=13pt,
  colback=paper, colframe=paper,
  borderline west={2pt}{0pt}{navy},
}
\newcommand{\eqn}[1]{\begin{empheq}[box=\eqbox]{equation}#1\end{empheq}}
...
% =====================================================================
% Generated from the factor registry by scripts/render_formula_appendix.py.
\input{factor-formulas}
